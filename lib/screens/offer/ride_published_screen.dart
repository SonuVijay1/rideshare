...
class RidePublishedScreen extends StatefulWidget {
  ...
  const RidePublishedScreen({super.key, required this.rideData, this.isUpdate = false, this.isBooking = false, this.isCancellation = false});
...
class _RidePublishedScreenState extends State<RidePublishedScreen>
  ...
  Widget build(BuildContext context) {
    ...
    String subtitle = widget.isUpdate ? "Your details have been updated." : "Operation successful.";
    if (widget.isCancellation) {
        subtitle = widget.isBooking 
            ? "Your booking has been successfully cancelled." 
            : "Your ride has been cancelled and passengers notified.";
    } else if (widget.isBooking) {
      subtitle = widget.isUpdate ? "Your booking has been updated." : "Your ride has been successfully booked.";
    } else {
      subtitle = widget.isUpdate ? "Your ride details have been updated." : "Your ride has been successfully posted.";
    }
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    _locationRow(
                        Icons.circle, Colors.green, data['from'] ?? ''),
                    Container(
